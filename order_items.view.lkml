...
#url: "/embed/looks/16"
      ...
      \"single_value_title\":\"ARM - Average Revenue per Member\" ,
      \"value_format\":\"$#.00\" ,
      \"series_types\":{}}' %}
      {{ link }}
      ...
      &limit=5000&column_limit=50
      &filter_config={{ filter_config | encode_uri }}
      &f[orders.created_date]={{ '18 months ago for 18 months' | url_encode }}"

    }}
#     link: {
#       label: "Trend from the last 18 months"
#       url:"
#       {% assign filter_config = '
# {\"orders.created_date\":
# [ {\"type\" :\"date\",
...
#       \"value_format\":\"$#.00\" ,
#       \"series_types\":{}}' %}
#       {{ link }}&vis_config={{ vis_config | encode_uri }}&sorts=order_items.count2 desc
#       &limit=5000&column_limit=50"
#          }
# }
#     link: {
...
#       ]
#       }' %}
#       {{ link }}&vis_config={{ vis_config | encode_uri }}&toggle=dat,pik,vis&limit=5000&f[orders.created_date]={{ '18 months' | url_encode }}"
# }}
